...
jQuery(document).ready(function($) {
  ...
  /*---------------------------------------------------------------*/
  function livesay_toggle_metaboxes() {
  ...
  livesay_toggle_metaboxes(); // Execute on document ready

  $('#post-formats-select input[type="radio"]').click(livesay_toggle_metaboxes);
